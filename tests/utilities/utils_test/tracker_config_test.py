...
def test_get_and_validate_configured_trackers_failures(trackers, all_trackers, mocker):
    ...
    with pytest.raises(AssertionError):
        assert utils.get_and_validate_configured_trackers(trackers, all_trackers, api_keys_dict, acronym_to_tracker.keys())
...
def test_prepare_and_validate_tracker_api_keys_dict(mocker):
    ...
    assert utils.prepare_and_validate_tracker_api_keys_dict(f'{working_folder}/parameters/tracker/api_keys.json') == expected
...
def test_validate_tracker_api_keys_no_tmdb(mocker):
    ...
    with pytest.raises(AssertionError):
        assert utils.prepare_and_validate_tracker_api_keys_dict(f'{working_folder}/parameters/tracker/api_keys.json')
...
def test_get_and_validate_configured_trackers(trackers, all_trackers, expected, mocker):
    ...
    assert utils.get_and_validate_configured_trackers(trackers, all_trackers, api_keys_dict, acronym_to_tracker.keys()) == expected
