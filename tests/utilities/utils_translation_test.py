...
def test_get_hybrid_type(load_config, tracker_settings, torrent_info, expected):
    assert translation.get_hybrid_type("subcat", tracker_settings, load_config, False, torrent_info) == expected
...
def test_get_hybrid_type_application_exit(load_config, tracker_settings, torrent_info):
    with pytest.raises(SystemExit) as pytest_wrapped_e:
            translation.get_hybrid_type("subcat", tracker_settings, load_config, True, torrent_info)
